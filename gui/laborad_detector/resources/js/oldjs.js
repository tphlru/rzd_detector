...
// const CRIME_STATS = {
//     cities: {
//         'Ярославль': { total: 41.18, property: 51.47, violent: 22.06 },
//         'Москва': { total: 34.34, property: 40.88, violsent: 28.39 },
//         'Самара': { total: 31.58, property: 44.08, violent: 22.37 },
//         'Архангельск': { total: 45.83, property: 62.50, violent: 33.33 },
//         'Пермь': { total: 48.57, property: 55.71, violent: 41.43 },
//         'Волгоград': { total: 50.00, property: 63.33, violent: 45.00 }
//     },
//     ageGroups: {
//         '14-17': 0.03,
//         '18-24': 0.15,
...
//                 type: "line",
//                 data: {
//                     labels: Array.from({length: blinkingValues.length}, (_, i) => i * 2),
//                     datasets: [{
//                         backgroundColor: "rgba(0,0,255,1.0)",
//                         borderColor: "rgba(0,0,255,0.7)",
//                         data: blinkingValues
