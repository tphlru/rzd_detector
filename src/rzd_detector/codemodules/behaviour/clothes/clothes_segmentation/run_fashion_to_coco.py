...
json_name = r'c:/Users/Georges/Projects/datasets/DeepFashion2/train/train_all.json'
with open(json_name, 'w') as f:
    json.dump(dataset, f)

to_coco(r'c:/Users/Georges/Projects/datasets/DeepFashion2', 2)
dataset = deep_fashion2_to_coco.dataset
json_name = r'c:/Users/Georges/Projects/datasets/DeepFashion2/validation/validation_all.json'
with open(json_name, 'w') as f:
    json.dump(dataset, f)
